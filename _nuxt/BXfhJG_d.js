import{_ as t}from"./DSArTXDP.js";import"./Bj-jG8Tx.js";const c={title:"DesignSysteme/Pricing/ItemPrice",component:t,tags:["autodocs"],parameters:{layout:"centered",docs:{description:{component:"Le composant ItemPrice est utilisé pour afficher des informations de prix au sein du système de design."}}},render:n=>({components:{ItemPrice:t},setup(){return{args:n}},template:`
      <div>
      <ItemPrice
        v-bind="args"
      />
