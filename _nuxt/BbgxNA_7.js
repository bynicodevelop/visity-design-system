 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Tt=Tm;function gc(t,e={}){let n=t;typeof e!="object"&&(e={name:e});const r=Object.assign({name:ns,automaticDataCollectionEnabled:!1},e),s=r.name;if(typeof s!="string"||!s)throw je.create("bad-app-name",{appName:String(s)});if(n||(n=fc()),!n)throw je.create("no-options");const i=Gt.get(s);if(i){if(Mn(n,i.options)&&Mn(r,i.config))return i;throw je.create("duplicate-app",{appName:s})}const o=new xp(s);for(const c of rs.values())o.addComponent(c);const a=new Am(n,r,o);return Gt.set(s,a),a}function yc(t=ns){const e=Gt.get(t);if(!e&&t===ns&&fc())return gc();if(!e)throw je.create("no-app",{appName:t});return e}function oo(){return Array.from(Gt.values())}function Be(t,e,n){var r;let s=(r=km[t])!==null&&r!==void 0?r:t;n&&(s+=`-${n}`);const i=s.match(/\s|\//),o=e.match(/\s|\//);if(i||o){const a=[`Unable to register library "${s}" with version "${e}":`];i&&a.push(`library name "${s}" contains illegal characters (whitespace or "/")`),i&&o&&a.push("and"),o&&a.push(`version name "${e}" contains illegal characters (whitespace or "/")`),we.warn(a.join(" "));return}Et(new tt(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qb(t,e){const n=t>=500&&t<600,s=[408,429].indexOf(t)!==-1,i=e.indexOf(t)!==-1;return n||s||i}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function jl(t){let e;try{e=JSON.parse(t)}catch{return null}return Gb(e)?e:null}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
